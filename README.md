...
This repository "https://github.com/BoraBaranBora/Interaction-resolved-decomposition-of-multi-qubit-unitaries-via-computational-basis-phases" accompanies the paper *Interaction-resolved decomposition of multi-qubit unitaries
via computational-basis phases* and provides the data and scripts used in the numerical demonstrations shown in the manuscript.
